...
def fetchAttendance(attendanceClass, attendanceDate):
    student_class = {
        "I": "SELECT DISTINCT(a.student_id), s.fullname, s.class, a.date, a.time FROM attendance_data a INNER JOIN student_data s ON s.student_id = a.student_id WHERE s.class = 'I' AND a.date = ?;",
        "II": "SELECT DISTINCT(a.student_id), s.fullname, s.class, a.date, a.time FROM attendance_data a INNER JOIN student_data s ON s.student_id = a.student_id WHERE s.class = 'II' AND a.date = ?;",
        "III": "SELECT DISTINCT(a.student_id), s.fullname, s.class, a.date, a.time FROM attendance_data a INNER JOIN student_data s ON s.student_id = a.student_id WHERE s.class = 'III' AND a.date = ?;",
    }
    conn = create_connection()
    cursor = conn.cursor()
    val = [attendanceDate]
...
def fetch_graph_data(graphClass):
    student_class = {
        "I": "SELECT DISTINCT(a.date) FROM attendance_data a INNER JOIN student_data s ON s.student_id = a.student_id WHERE s.class = 'I' ORDER BY a.date ASC LIMIT 10",
        "II": "SELECT DISTINCT(a.date) FROM attendance_data a INNER JOIN student_data s ON s.student_id = a.student_id WHERE s.class = 'II' ORDER BY a.date ASC LIMIT 10",
        "III": "SELECT DISTINCT(a.date) FROM attendance_data a INNER JOIN student_data s ON s.student_id = a.student_id WHERE s.class = 'III' ORDER BY a.date ASC LIMIT 10",
    }
    attendance_class = {
        "I": "SELECT COUNT(DISTINCT(a.student_id)) FROM attendance_data a INNER JOIN student_data s ON s.student_id = a.student_id WHERE s.class = 'I' AND a.date = ?;",
        "II": "SELECT COUNT(DISTINCT(a.student_id)) FROM attendance_data a INNER JOIN student_data s ON s.student_id = a.student_id WHERE s.class = 'II' AND a.date = ?;",
        "III": "SELECT COUNT(DISTINCT(a.student_id)) FROM attendance_data a INNER JOIN student_data s ON s.student_id = a.student_id WHERE s.class = 'III' AND a.date = ?;",
    }
